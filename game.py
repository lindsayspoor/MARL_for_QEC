...
class ToricCodeGame():
    ...
    def play_test(self, nn, error_rate, reward_mode, mode, seed=None, without_illegal_actions=False, verbose=False):

        current_state = self.env.generate_errors_test(error_rate)
        ...
        for step in range(self.max_steps+1):
            ...
            current_state, reward, done, info = self.env.step_test(location, action, without_illegal_actions)
